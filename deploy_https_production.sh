...
server {
    ...
    # Static files
    location /static/ {
        alias /home/user/Alphalexnew/LexOS\ Platform\ Dashboard/lexos/frontend/;
        expires 1y;
...
cd "/home/user/Alphalexnew/LexOS Platform Dashboard/lexos"
...
# Create directories
sudo -u user mkdir -p data/{lmdb,vectors,uploads,cache} models/{avatar,custom} logs frontend/dist

# Install Python dependencies
print_status "Installing Python dependencies..."
sudo -u user pip3 install --user --upgrade pip
sudo -u user pip3 install --user -r requirements.txt
...
User=user
Group=user
WorkingDirectory=/home/user/Alphalexnew/LexOS Platform Dashboard/lexos
Environment=PATH=/home/user/.local/bin:/usr/local/bin:/usr/bin:/bin
Environment=PYTHONPATH=/home/user/Alphalexnew/LexOS Platform Dashboard/lexos
EnvironmentFile=/home/user/Alphalexnew/LexOS Platform Dashboard/lexos/.env.production
...
ProtectHome=true
ReadWritePaths=/home/user/Alphalexnew/LexOS Platform Dashboard/lexos/data
ReadWritePaths=/home/user/Alphalexnew/LexOS Platform Dashboard/lexos/logs
ReadWritePaths=/home/user/Alphalexnew/LexOS Platform Dashboard/lexos/models
...
cat > "/home/user/Alphalexnew/LexOS Platform Dashboard/lexos/manage_lexos.sh" << 'EOF'
#!/bin/bash
...
chown user:user "/home/user/Alphalexnew/LexOS Platform Dashboard/lexos/manage_lexos.sh"
chmod +x "/home/user/Alphalexnew/LexOS Platform Dashboard/lexos/manage_lexos.sh"
